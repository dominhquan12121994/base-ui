        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <!-- Error -->
                        <p class="text-danger" v-show="errorsValidateValidate.group_name">{{ errorsValidateValidate.group_name }}</p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <!-- Error -->
                        <p class="text-danger" v-show="errorsValidateValidate.store_id">{{ errorsValidateValidate.store_id }}</p>
            ...
            <div class="card-body" v-if="loading">
                <div class="row">
                    ...
                    <!-- Error -->
                    <p class="text-danger" v-show="errorsValidateValidate.subsystem_id">{{ errorsValidateValidate.subsystem_id }}</p>
                </div>
                ...
                <!-- Error -->
                <p class="text-danger" v-show="errorsValidateValidate.permission_id">{{ errorsValidateValidate.permission_id }}</p>

                <button class="float-right btn btn-primary" @click="actionSubmit" v-if="!loadingAjax">Thêm mới</button>
...
export default {
    ...
    beforeCreate() {
        axios.get("/proxy/account/v1/nhom-quyen/create")
            .then(response => {
    ...
    mounted() {
        this.$store.dispatch(SET_BREADCRUMB, [
            ...
            {title: "Tạo mới nhóm quyền", route: "/account/permissiongroup/create"}
        ]);
    ...
    methods: {
        actionSubmit: function() {
            ...
            axios.post("/proxy/account/v1/nhom-quyen", {
            ...
            .then(function(response){
                ...
                if (response.data.status_code == 200) {
                    Swal.fire(
                        'Thành công!',
                        'Đã tạo mới nhóm quyền thành công',
                        'success'
                    ).then((result) => {
                ...
                if (response.data.status_code == 422) {
                    if (response.data.errors.group_name) {
                        _that.errorsValidateValidate.group_name = response.data.errors.group_name.msg;
                    } else {
                        _that.errorsValidateValidate.group_name = '';
                    }
                    if (response.data.errors.store_id) {
                        _that.errorsValidateValidate.store_id = response.data.errors.store_id.msg;
                    } else {
                        _that.errorsValidateValidate.store_id = '';
                    }
                    if (response.data.errors.permission_id) {
                        _that.errorsValidateValidate.permission_id = response.data.errors.permission_id.msg;
                    } else {
                        _that.errorsValidateValidate.permission_id = '';
                    }
                    if (response.data.errors.subsystem_id) {
                        _that.errorsValidateValidate.subsystem_id = response.data.errors.subsystem_id.msg;
                    } else {
                        _that.errorsValidateValidate.subsystem_id = '';
                    }
                    checkValidate = false;
                }
                if (checkValidate) {
