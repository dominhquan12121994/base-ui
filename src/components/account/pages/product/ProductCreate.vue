...
import CreateTongCty from "@/components/account/pages/product/corporations/ProductCreate.vue";
import CreateChiNhanh from "@/components/account/pages/product/branch/ProductCreate.vue";
...
export default {
    ...
    mounted() {
        this.$store.dispatch(SET_BREADCRUMB, [
            ...
            {title: "Thêm mới chuẩn hóa sản phẩm", route: "/account/product/create"}
        ]);
