                        ...
                        <div class="row">
                                ...
                                <b-input-group v-if="page.loading">
                                    ...
                                    <b-input-group-append>
                                        <select class="form-control" v-model="input.volume_unit_id" disabled>
                                            <option v-for="donVi in data.volume_unit" :key="donVi.id" :value="donVi.id">{{ donVi.ten_don_vi_quantity }}</option>
                                        </select>
                                    </b-input-group-append>
                                </b-input-group>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" v-model="input.store_id">
                                    <option v-for="store in data.stores" :key="store.id" :value="store.id">{{ store.store_name }}</option>
                                </select>
...
export default {
    ...
    beforeCreate() {
        axios.get("/proxy/account/v1/san-pham/create")
            .then(response => {
                this.data.product_catalog = response.data.data.product_catalog;
                this.data.volume_unit = response.data.data.volume_unit;
                this.data.stores =  response.data.data.stores;
                this.page.loading = true;
            })
            .catch(error => console.log(error))
        axios.get("/proxy/account/v1/search-product?limit=5")
            .then(response => {
    ...
    computed: {
        optionLoaiSanPham: function () {
            return this.generateOption(this.data.product_catalog);
        }
    },
    methods: {
        ...
        selectLoaiSanPham: function (value) {
            let attributes_group = this.data.product_catalog.filter(word => word.id == value)[0].attributes_group;
            let array = [];
