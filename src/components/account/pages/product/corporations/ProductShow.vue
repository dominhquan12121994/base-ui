                    ...
                    <div class="card p-3">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <p>Giá bán lẻ: {{ data.product_entities[0].entity_prices.old_prices }}</p>
                                        <p>Giá bán buôn: {{ data.product_entities[0].entity_prices.old_wholesale_prices }}</p>
                                    </td>
                                    <td>
                                        <p>Giá vốn: {{ data.product_entities[0].entity_prices.old_cost_prices }}</p>
                                        <p></p>
                                    </td>
                                </tr>
                            </tbody>
