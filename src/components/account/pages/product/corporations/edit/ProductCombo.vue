...
export default {
    ...
    mounted() {
        ...
        this.sanPham.combos.forEach(combo => {
            ...
            sanphamCombo.wholesale_prices = this.sanPham.product_entities[0].entity_prices.old_wholesale_prices;
            sanphamCombo.cost_prices = this.sanPham.product_entities[0].entity_prices.old_cost_prices;
