<template>
  <b-modal
    title="Nhập dữ liệu sản phẩm đơn"
    size="md"
    id="modal_import_product_single"
    hide-footer
  >
    <div class="px-5">
        ...
        <div class="m-sm-5">
            ...
            <p>
                ...
                <a v-if="currentOwnerShop" href="/download/template-single">tại đây</a>
                <a v-else href="/download/template-single-branch">tại đây</a>
            </p>
