            ...
            <div class="container p-0">
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <!-- Nút bấm -->
                        <approve-btn-block class="mt-3"></approve-btn-block>
                    </div>
                </div>
            </div>
        </div>
...
import ApproveBtnBlock from "./ApproveBtnBlock";
...
export default {
    ...
    components: { ProductsBlock, InvoiceBlock, AdditionBlock, ApproveBtnBlock, NoteBlock, Step },
