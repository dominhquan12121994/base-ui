...
import {STATUS_REJECT_LEAD, STATUS_WAIT_LEAD} from "@/config/app";

export default {
  name: "ModalEditDataLead",
  data() {
    return {
      modalName: 'modal-edit-data-lead',
      ...
      listStatusEdit: new Collection(LeadStatus),
      types: [
