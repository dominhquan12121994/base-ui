                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <FieldDonHang
                                    ...
                                    :disabled="disableOrderSelector"
                                ></FieldDonHang>
                                <FieldGiaTri
                                    :receipt-voucher="receiptModel"
                                    v-model="amount"
                                    :disabled="canShowPaymentsSelector"
                                ></FieldGiaTri>
                            </div>
                            <div class="col-12 col-sm-6">
                                <FieldGhiChu v-model="receiptModel.note"> </FieldGhiChu>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <v-checkbox
                                    v-model="receiptModel.is_accounting"
...
export default {
    ...
    computed: {
         ...
         */
        amount() {
            return (this.receiptModel.amount = _.chain(this.receiptModel.orders || [])
                .reduce(function (res, order) {
                    return res + _.sumBy(order.payments || [], 'payment_amount');
                }, 0)
                .value());
        },
    },
