...
export default {
     ...
     * @param      {<type>}  payload      The payload
     */
    [actions.CLEAN_MODEL_SELL]({ commit }, payload) {
        commit(mutations.CLEAN_MODEL_SELL);
     ...
     * @param      {<type>}  payload      The payload
     */
    [actions.CLEAN_MODEL_INTERNAL]({ commit }, payload) {
        commit(mutations.CLEAN_MODEL_INTERNAL);
